#ch3cksout:	adding set_hash_table_size; NOTE the default is 16, very small!
# BEWARE this would play without setting time?
#$ stockfish uci|grep -i time
...
class StockfishUCIElo(Player):
    ...
    #ch3cksout:
    def set_hash_table_size(self, size_mb: int):
        # Set the Hash option to the desired size in megabytes
        self._engine.configure({"Hash": size_mb})
...
if __name__ == "__main__":
    ...
    for i in range(2):
        ...
        player_two.set_hash_table_size(256)  # Set the hash table size to 256 MB
        ...
        player_one.set_hash_table_size(256)  # Set the hash table size to 256 MB
        play_game(player_one, player_two, num_games)
