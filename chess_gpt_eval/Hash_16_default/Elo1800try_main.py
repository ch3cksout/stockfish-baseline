...
if __name__ == "__main__":
    ...
    for i in range(2):
        ...
        player_two = StockfishUCIElo(skill_level=4, play_time=1.9, UCI_LimitStrength=True, UCI_Elo=1800)
        ...
        player_two = GPTPlayer(model="gpt-3.5-turbo-instruct")
        player_one = StockfishUCIElo(skill_level=4, play_time=1.9, UCI_LimitStrength=True, UCI_Elo=1800)
        play_game(player_one, player_two, num_games)
