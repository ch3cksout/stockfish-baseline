...
def get_player_titles(player_one: Player, player_two: Player) -> Tuple[str, str]:
    ...
    if "model" in player_one_config:
        ...
        player_one_title = (f"Stockfish_PlayTime={player_one_config['play_time']}_"
                            ...
                            f"UCI_LimitStrength={player_one_config['UCI_LimitStrength']}_"
    ...
    if "model" in player_two_config:
        ...
        player_two_title = (f"Stockfish_PlayTime={player_two_config['play_time']}_"
                            ...
                            f"UCI_LimitStrength={player_two_config['UCI_LimitStrength']}_"
...
if __name__ == "__main__":
    ...
    for i in range(6):
        ...
        # give fixed time/move equivalent to CCRL 40/15min
        player_two = StockfishUCIElo(skill_level=4, play_time=15*60/40*0.72614410905550146056, UCI_LimitStrength=True, UCI_Elo=1800)
        ...
        # give fixed time/move equivalent to CCRL 40/15min
        player_one = StockfishUCIElo(skill_level=4, play_time=15*60/40*0.72614410905550146056, UCI_LimitStrength=True, UCI_Elo=1800)
        play_game(player_one, player_two, num_games)
