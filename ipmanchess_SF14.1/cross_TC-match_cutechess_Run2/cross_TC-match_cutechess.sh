...
cutechess-cli -repeat -rounds 4 -games 2 -tournament round-robin \
                ...
                -engine tc=40/240.0 name=Elo1785_40_240,000ms cmd=/var/chess/ipmanchess_SF14.1/stockfish_21102807_x64_bmi2 option.UCI_LimitStrength=true option.UCI_Elo=1785 \
                	option.EvalFile=/var/chess/ipmanchess_SF14.1/nn-13406b1dcbe0.nnue option."Use NNUE=true" \
                -engine tc=40/60.0+0.6 name=Elo1785_40_60,000+600ms cmd=/var/chess/ipmanchess_SF14.1/stockfish_21102807_x64_bmi2 option.UCI_LimitStrength=true option.UCI_Elo=1785 \
                	option.EvalFile=/var/chess/ipmanchess_SF14.1/nn-13406b1dcbe0.nnue option."Use NNUE=true" \
                -engine tc=40/60.0+0.6 name=SkillLevel4_40_60,000+600ms cmd=/var/chess/ipmanchess_SF14.1/stockfish_21102807_x64_bmi2 option."Skill Level=4" \
                	option.EvalFile=/var/chess/ipmanchess_SF14.1/nn-13406b1dcbe0.nnue option."Use NNUE=true" \
                -engine tc=1/0.020 name=Elo1785_20ms cmd=/var/chess/ipmanchess_SF14.1/stockfish_21102807_x64_bmi2 option.UCI_LimitStrength=true option.UCI_Elo=1785 \
                	option.EvalFile=/var/chess/ipmanchess_SF14.1/nn-13406b1dcbe0.nnue option."Use NNUE=true" \
                -engine tc=1/0.100 name=Elo1785_100ms cmd=/var/chess/ipmanchess_SF14.1/stockfish_21102807_x64_bmi2 option.UCI_LimitStrength=true option.UCI_Elo=1785 \
                	option.EvalFile=/var/chess/ipmanchess_SF14.1/nn-13406b1dcbe0.nnue option."Use NNUE=true" \
