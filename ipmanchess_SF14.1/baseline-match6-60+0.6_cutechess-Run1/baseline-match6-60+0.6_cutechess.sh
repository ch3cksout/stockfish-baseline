...
cutechess-cli -repeat -rounds 16 -games 2 -tournament gauntlet \
                ...
                -engine name=SkillLevel4 cmd=/var/chess/ipmanchess/stockfish_21102807_x64_bmi2 option."Skill Level=4" \
                	option.EvalFile=/var/chess/ipmanchess/nn-13406b1dcbe0.nnue option."Use NNUE=true" \
                -engine name=SkillLevel3 cmd=/var/chess/ipmanchess/stockfish_21102807_x64_bmi2 option."Skill Level=3" \
                	option.EvalFile=/var/chess/ipmanchess/nn-13406b1dcbe0.nnue option."Use NNUE=true" \
                -engine name=SkillLevel5 cmd=/var/chess/ipmanchess/stockfish_21102807_x64_bmi2 option."Skill Level=5" \
                	option.EvalFile=/var/chess/ipmanchess/nn-13406b1dcbe0.nnue option."Use NNUE=true" \
                -engine name=Elo1685 cmd=/var/chess/ipmanchess/stockfish_21102807_x64_bmi2 option.UCI_LimitStrength=true option.UCI_Elo=1685 \
                	option.EvalFile=/var/chess/ipmanchess/nn-13406b1dcbe0.nnue option."Use NNUE=true" \
                -engine name=Elo1785 cmd=/var/chess/ipmanchess/stockfish_21102807_x64_bmi2 option.UCI_LimitStrength=true option.UCI_Elo=1785 \
                	option.EvalFile=/var/chess/ipmanchess/nn-13406b1dcbe0.nnue option."Use NNUE=true" \
                -engine name=Elo1885 cmd=/var/chess/ipmanchess/stockfish_21102807_x64_bmi2 option.UCI_LimitStrength=true option.UCI_Elo=1885 \
                	option.EvalFile=/var/chess/ipmanchess/nn-13406b1dcbe0.nnue option."Use NNUE=true" \
                -ratinginterval 1 -each tc=40/60.0+0.6 proto=uci option.Threads=10 -pgnout $0_result.pgn
