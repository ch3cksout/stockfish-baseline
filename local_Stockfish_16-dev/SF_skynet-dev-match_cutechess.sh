...
cutechess-cli -repeat -rounds 8 -games 2 -tournament round-robin \
                ...
                -engine tc=40/60.0+0.6 name=Threads10_stockfish_15.1_Elo1700_40_60,000+600ms cmd=/usr/games/stockfish option.UCI_LimitStrength=true option.UCI_Elo=1700 \
                	option.Threads=10 \
                	option.Hash=6500 \
                	option.EvalFile=/var/chess/nn-ad9b42354671.nnue option."Use NNUE=true" \
                -engine tc=40/60.0+0.6 name=Threads1_stockfish_15.1_Elo1700_40_60,000+600ms cmd=/usr/games/stockfish option.UCI_LimitStrength=true option.UCI_Elo=1700 \
                	option.Threads=1 \
                	option.Hash=6500 \
                	option.EvalFile=/var/chess/nn-ad9b42354671.nnue option."Use NNUE=true" \
                -engine tc=40/60.0+0.6 name=stockfish_15.1_skynet-dev_handicapped cmd=/usr/games/stockfish option.UCI_LimitStrength=true option.UCI_Elo=1700 \
                	option.Threads=1 \
                	option.Hash=16 \
                	option.EvalFile=/var/chess/nn-ad9b42354671.nnue option."Use NNUE=true" \
