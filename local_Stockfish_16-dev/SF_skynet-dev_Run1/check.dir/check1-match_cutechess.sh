...
cutechess-cli -repeat -rounds 1 -games 2 -tournament round-robin \
                ...
                -engine tc=40/10.0+0.6 name=stockfish_Copy1 cmd=/usr/games/stockfish option.UCI_LimitStrength=true option.UCI_Elo=1700 \
                	option.Threads=1 \
                	option.Hash=16 \
                	option.EvalFile=/var/chess/nn-ad9b42354671.nnue option."Use NNUE=true" \
                -engine tc=40/10.0+0.6 name=stockfish_Copy2 cmd=/usr/games/stockfish option.UCI_LimitStrength=true option.UCI_Elo=1700 \
                	option.Threads=1 \
                	option.Hash=16 \
                	option.EvalFile=/var/chess/nn-ad9b42354671.nnue option."Use NNUE=true" \
