...
cutechess-cli -repeat -rounds 1 -games 2 -tournament round-robin \
                ...
                -engine tc=40/10.0+0.6 name=stockfish_15.1_skynet-dev_handicapped-Copy1 cmd=/usr/games/stockfish option.UCI_LimitStrength=true option.UCI_Elo=1700 \
                	option.Threads=10 \
                	option.Hash=1600 \
                	option.EvalFile=/var/chess/nn-ad9b42354671.nnue option."Use NNUE=true" \
                -engine tc=40/10.0+0.6 name=stockfish_15.1_skynet-dev_handicapped-Copy2 cmd=/usr/games/stockfish option.UCI_LimitStrength=true option.UCI_Elo=1700 \
                	option.Threads=10 \
                	option.Hash=1600 \
                	option.EvalFile=/var/chess/nn-ad9b42354671.nnue option."Use NNUE=true" \
