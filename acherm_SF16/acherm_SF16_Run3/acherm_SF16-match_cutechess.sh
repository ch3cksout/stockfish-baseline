...
cutechess-cli -repeat -rounds 8 -games 2 -tournament round-robin \
                ...
                -engine tc=1/0.020+0.020 name=stockfish_16-SL4_acherm_handicapped_20ms cmd=/opt/stockfish/16/avx2/stockfish-ubuntu-x86-64-avx2 option."Skill Level=4" \
                	option.Threads=1 \
                	option.Hash=16 \
                ...
                -engine tc=1/0.100+0.100 name=stockfish_16-SL4_acherm_handicapped_100ms cmd=/opt/stockfish/16/avx2/stockfish-ubuntu-x86-64-avx2 option."Skill Level=4" \
                	...
                	option.Hash=16 \
                	option.EvalFile=/var/chess/nn-5af11540bbfe.nnue option."Use NNUE=true" \
                -engine tc=1/6.000+6.000 name=stockfish_16-SL4_acherm_handicapped_6000ms cmd=/opt/stockfish/16/avx2/stockfish-ubuntu-x86-64-avx2 option."Skill Level=4" \
                	option.Threads=1 \
                	option.Hash=16 \
                	option.EvalFile=/var/chess/nn-5af11540bbfe.nnue option."Use NNUE=true" \
                -engine tc=120+1 name=stockfish_16-SL4_UNhandicapped_4min+1sec cmd=/opt/stockfish/16/avx2/stockfish-ubuntu-x86-64-avx2 option."Skill Level=4" \
                	option.Threads=10 \
                	option.Hash=1600 \
                	option.EvalFile=/var/chess/nn-5af11540bbfe.nnue option."Use NNUE=true" \
                -engine tc=40/60.0+0.6 name=Threads10_stockfish_15.1_Elo1785_40_60,000+600ms cmd=/usr/games/stockfish option.UCI_LimitStrength=true option.UCI_Elo=1785 \
                	option.Threads=10 \
                	option.Hash=1600 \
