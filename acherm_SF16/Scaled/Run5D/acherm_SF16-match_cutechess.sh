...
echo "run: $0, 1x50x2 games, cross-validating runs"
...
cutechess-cli -repeat -rounds 50 -games 2 -tournament round-robin \
                ...
                -concurrency 6 -openings file=/var/chess/UHO_XXL_+0.90_+1.19.epd format=epd order=random plies=16 \
