...
cutechess-cli -repeat -rounds 16 -games 2 -tournament round-robin \
                ...
                -engine st="$Rescaled_100ms" name="Stockfish_Ver16_Skill=5_st=0.100sec" cmd=/opt/stockfish/16/avx2/stockfish-ubuntu-x86-64-avx2 option."Skill Level=5" \
                	...
                	option.Hash=16 \
                	option.EvalFile=/var/chess/nn-5af11540bbfe.nnue option."Use NNUE=true" \
                -engine st=0.020 name="stockfish_16-SL4_acherm_handicapped_st=20ms" cmd=/opt/stockfish/16/avx2/stockfish-ubuntu-x86-64-avx2 option."Skill Level=5" \
                	option.Threads=1 \
                	option.Hash=16 \
                	option.EvalFile=/var/chess/nn-5af11540bbfe.nnue option."Use NNUE=true" \
                -engine st=0.100 name="stockfish_16-SL4_acherm_handicapped_st=100ms" cmd=/opt/stockfish/16/avx2/stockfish-ubuntu-x86-64-avx2 option."Skill Level=5" \
                	option.Threads=1 \
                	option.Hash=16 \
                	option.EvalFile=/var/chess/nn-5af11540bbfe.nnue option."Use NNUE=true" \
